describe('Blog app', function () {
  ...
  describe('Blogs are sorted correctly', function () {
    ...
    it('All blogs are in order according to like after user have changed the like-state', function () {
      cy.contains('blogs')
      cy.get('#newBlogButton').click()
      ...
      cy.get('#submit').click()
      cy.contains('Testing_Title1 testing_author1')
      ...
      cy.get('#Testing_Title2-viewButton').contains('view').click()
      cy.get('#Testing_Title2-likeButton').contains('like').click()

      cy.get('#Testing_Title1-viewButton').contains('view').click()
      cy.get('#Testing_Title1-likeButton').contains('like').click()
      cy.get('#Testing_Title2-likeButton').contains('like').click()


      cy.get('.blog').eq(0).should('contain', 'Testing_Title2')
      cy.get('.blog').eq(1).should('contain', 'Testing_Title1')
      cy.get('.blog').eq(2).should('contain', 'Testing_Title3')
    })
  })
})
